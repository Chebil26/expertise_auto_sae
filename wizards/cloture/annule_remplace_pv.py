...
class AnnuleEtRemplace(models.TransientModel):
    _name = 'annule.remplace.pv.wizard'
    ...
    def _get_default_text_confirmation(self):
        return "Etes-vous sure de vouloir annuler ce dossier"

    text_confirmation = fields.Char(default=_get_default_text_confirmation, readonly=1)

    def confirmer(self):
        self.dossier_id.write({"annule_remplace": True})
        self.dossier_id.write({"state": "annule"})
        photo_ids = []
        for photo in self.dossier_id.photos_ids.ids:
            img = []
        ...
        choc = []
        for chocs in self.dossier_id.chocs_ids:
            choc.append([0, 0, {
                'classe': chocs.classe,
                'name': chocs.name.id,
                'desc': chocs.desc,
        ...
        reparations = []
        for reparation in self.dossier_id.reparations1_ids:
        ...
        reparation2 = []
        for reparation in self.dossier_id.reparations2_ids:
        ...
        reparation3 = []
        for reparation in self.dossier_id.reparations3_ids:
        ...
        reparation4 = []
        for reparation in self.dossier_id.reparations4_ids:
        ...
        reparation5 = []
        for reparation in self.dossier_id.reparations5_ids:
        ...
        reparation6 = []
        for reparation in self.dossier_id.reparations6_ids:
        ...
        fourniture1 = []
        for fourniture in self.dossier_id.fournitures1_ids:
            list_tax = []
        ...
        fourniture2 = []
        for fourniture in self.dossier_id.fournitures2_ids:
            list_tax = []
            for tax in fourniture.taxe_ids:
                list_tax.append(tax.id)
        ...
        fourniture3 = []
        for fourniture in self.dossier_id.fournitures3_ids:
            list_tax = []
            for tax in fourniture.taxe_ids:
                list_tax.append(tax.id)
        ...
        fourniture4 = []
        for fourniture in self.dossier_id.fournitures4_ids:
            list_tax = []
            for tax in fourniture.taxe_ids:
                list_tax.append(tax.id)
        ...
        fourniture5 = []
        for fourniture in self.dossier_id.fournitures5_ids:
            list_tax = []
            for tax in fourniture.taxe_ids:
                list_tax.append(tax.id)
        ...
        fourniture6 = []
        for fourniture in self.dossier_id.fournitures6_ids:
            list_tax = []
            for tax in fourniture.taxe_ids:
                list_tax.append(tax.id)
        ...
        pv_remplacer = {
            ...
            "lieu_id": self.dossier_id.lieu_id.id,
            "state": 'acpt',
        ...
        auto = self.env["sae.expertise.auto"].create(pv_remplacer)
